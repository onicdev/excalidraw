...
export const StickerIcon = createIcon(
  <path d="M7 2C4.23858 2 2 4.23858 2 7V17C2 19.7614 4.23858 22 7 22H11.3431C12.6692 22 13.941 21.4732 14.8787 20.5355L20.5355 14.8787C21.4732 13.941 22 12.6692 22 11.3431V7C22 4.23858 19.7614 2 17 2H7ZM4 7C4 5.34315 5.34315 4 7 4H17C18.6569 4 20 5.34315 20 7V11.3431C20 11.5659 19.9752 11.7861 19.9272 12H17C14.2386 12 12 14.2386 12 17V19.9272C11.7861 19.9752 11.5659 20 11.3431 20H7C5.34315 20 4 18.6569 4 17V7ZM14 18.5858L18.5858 14H17C15.3431 14 14 15.3431 14 17V18.5858Z" />,
  { ...tablerIconProps, fillRule: "evenodd", strokeWidth: 0 },
);

export const StickerIconSolid = createIcon(
  <path d="M2 7C2 4.23858 4.23858 2 7 2H17C19.7614 2 22 4.23858 22 7V11.3431C22 11.564 21.9854 11.7834 21.9567 12H17C14.2386 12 12 14.2386 12 17V21.9567C11.7834 21.9854 11.564 22 11.3431 22H7C4.23858 22 2 19.7614 2 17V7ZM14 21.2357C14.3158 21.0376 14.6109 20.8033 14.8787 20.5355L20.5355 14.8787C20.8033 14.6109 21.0376 14.3158 21.2357 14H17C15.3431 14 14 15.3431 14 17V21.2357Z" />,
  { ...tablerIconProps, fillRule: "evenodd", strokeWidth: 0 },
);
